...
const AnnouncementBar = () => {
  ...
  return (
    <div className="sticky top-0 z-50 w-full bg-[#efd7e5] border-b border-[#efd7e5]/30 py-1.5 px-4 shadow-[0_4px_20px_rgba(0,0,0,0.3)] backdrop-blur-md">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center max-w-xl mx-auto">
        ...
        <div className="flex items-center justify-center gap-3">
            <div className="flex items-center justify-center gap-2 text-center">
              <Clock 
                className="w-3.5 h-3.5 text-[#393939] animate-pulse shrink-0" 
                strokeWidth={2.5}
              />
              <p className="text-[#393939] text-[11px] font-bold tracking-tight text-center">
                You have{" "}
                <span className="text-[#393939] tabular-nums font-black">
                  {formatTime(timeLeft)}
                </span>{" "}
                minutes left to unlock your Kylie Cosmetics reward
              </p>
            </div>
        </div>
        ...
        <div className="flex items-center gap-2 mt-0.5">
          <div className="h-[1px] w-4 bg-[#393939]"></div>
          <p className="text-[#393939] text-[9px] uppercase tracking-[0.15em] font-bold">
